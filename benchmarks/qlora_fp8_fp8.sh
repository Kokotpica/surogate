...
QLORA_BITS="fp8" # you can change this to other quantization bits like fp8, fp4
...
./csrc/build/train --model $MODEL --train-file=$TRAIN_FILES --eval-file=$EVAL_FILE  \
    ...
    --qlora-$QLORA_BITS --save --out-dir=qlora_fp8_fp8 --recompute-block --offload-residual